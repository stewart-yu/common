...
import (
	...
	cmcomponentconfig "k8s.io/kubernetes/cmd/controller-manager/apis/componentconfig"
)

// +k8s:deepcopy-gen:interfaces=k8s.io/apimachinery/pkg/runtime.Object

// PodGCControllerConfiguration contains elements describing kube-controller manager.
type KubeControllerManagerConfiguration struct {
	metav1.TypeMeta `json:",inline"`

	// CloudProviderConfiguration holds configuration for CloudProvider related features.
	CloudProvider cmcomponentconfig.CloudProviderConfiguration `json:"cloudProvider"`
	// DebuggingConfiguration holds configuration for Debugging related features.
	Debugging cmcomponentconfig.DebuggingConfiguration `json:"debugging"`
	...
	GenericComponent cmcomponentconfig.GenericComponentConfiguration `json:"genericComponent"`
	// KubeCloudSharedConfiguration holds configuration for shared related features
	// both in cloud controller manager and kube-controller manager.
	KubeCloudShared cmcomponentconfig.KubeCloudSharedConfiguration `json:"kubeCloudShared"`
	// ServiceControllerConfiguration holds configuration for ServiceController
	// related features.
	ServiceController cmcomponentconfig.ServiceControllerConfiguration `json:"serviceController"`

	// AttachDetachControllerConfiguration holds configuration for
	// AttachDetachController related features.
	AttachDetachController AttachDetachControllerConfiguration `json:"attachDetachController"`
	// CSRSigningControllerConfiguration holds configuration for
	// CSRSigningController related features.
	CSRSigningController CSRSigningControllerConfiguration `json:"csrSigningController"`
	// DaemonSetControllerConfiguration holds configuration for DaemonSetController
	// related features.
	DaemonSetController DaemonSetControllerConfiguration `json:"daemonSetController"`
	// DeploymentControllerConfiguration holds configuration for
	// DeploymentController related features.
	DeploymentController DeploymentControllerConfiguration `json:"deploymentController"`
	...
	// related features.
	EndPointController EndPointControllerConfiguration `json:"endPointController"`
	// GarbageCollectorControllerConfiguration holds configuration for
	// GarbageCollectorController related features.
	GarbageCollectorController GarbageCollectorControllerConfiguration `json:"garbageCollectorController"`
	// HPAControllerConfiguration holds configuration for HPAController related features.
	HPAController HPAControllerConfiguration `json:"hpaController"`
	// JobControllerConfiguration holds configuration for JobController related features.
	JobController JobControllerConfiguration `json:"jobController"`
	// NamespaceControllerConfiguration holds configuration for NamespaceController
	// related features.
	NamespaceController NamespaceControllerConfiguration `json:"namespaceController"`
	// NodeIpamControllerConfiguration holds configuration for NodeIpamController
	// related features.
	NodeIpamController NodeIpamControllerConfiguration `json:"nodeIpamController"`
	// NodeLifecycleControllerConfiguration holds configuration for
	// NodeLifecycleController related features.
	NodeLifecycleController NodeLifecycleControllerConfiguration `json:"nodeLifecycleController"`
	// PersistentVolumeBinderControllerConfiguration holds configuration for
	// PersistentVolumeBinderController related features.
	PersistentVolumeBinderController PersistentVolumeBinderControllerConfiguration `json:"persistentVolumeBinderController"`
	// PodGCControllerConfiguration holds configuration for PodGCController
	// related features.
	PodGCController PodGCControllerConfiguration `json:"podGCController"`
	// ReplicaSetControllerConfiguration holds configuration for ReplicaSet related features.
	ReplicaSetController ReplicaSetControllerConfiguration `json:"replicaSetController"`
	// ReplicationControllerConfiguration holds configuration for
	// ReplicationController related features.
	ReplicationController ReplicationControllerConfiguration `json:"replicationController"`
	// ResourceQuotaControllerConfiguration holds configuration for
	// ResourceQuotaController related features.
	ResourceQuotaController ResourceQuotaControllerConfiguration `json:"resourceQuotaController"`
	// SAControllerConfiguration holds configuration for ServiceAccountController
	// related features.
	SAController SAControllerConfiguration `json:"saController"`
...
// DeprecatedControllerConfiguration contains elements describing DeprecatedController.
